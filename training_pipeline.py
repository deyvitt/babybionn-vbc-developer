...
# Fix imports by adding the current directory to path
import sys
import os
...
try:
    ...
    print("Warning: learning_analytics not found, using mock")
    # Create a mock for testing
    class LearningAnalytics:
        def record_interaction(self, *args, **kwargs): pass
        def generate_learning_report(self): return "Mock report"

try:
    from neuron.reinforcement_learning.training.pretraining_processor import BabyBIONNPretrainer, PretrainingConfig, create_pretrainer
except ImportError:
    print("Warning: pretraining_processor not found, using mock")
    # Create mocks for testing
    class PretrainingConfig: pass
    class BabyBIONNPretrainer: 
        def pretrain_domain(self, *args, **kwargs): return {'success': True}
    def create_pretrainer(*args): return BabyBIONNPretrainer()
